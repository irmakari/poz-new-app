...
export const FILM_PRESETS: FilmPreset[] = [
  ...
  { id: 'ft-bw', name: 'Black & White', iso: 400, description: 'kontrastlı siyah beyaz', primaryColor: '#2A1730', serialPrefix: 'BW' },
];
...
export const MOCK_FILMS: FilmItem[] = [
  ...
  makeFilm({
    ...
    photos: Array.from({ length: 8 }).map((_, i) => ({
      ...
      dateStr: '27.07',
      isExposed: true,
      bgColors: ['#111827', '#2A1730'] as [string, string],
  ...
  makeFilm({
    ...
    photos: Array.from({ length: 12 }).map((_, i) => ({
      ...
      dateStr: '27.07',
      isExposed: true,
      bgColors: ['#182235', '#2A1730'] as [string, string],
      iconName: 'photo' as const,
    })),
    notes: [],
    songs: [],
  ...
  makeFilm({
    ...
    photos: Array.from({ length: 12 }).map((_, i) => ({
      ...
      dateStr: '29.07',
      isExposed: false,
      bgColors: ['#2A1730', '#111827'] as [string, string],
  ...
  makeFilm({
    ...
    photos: [
      ...
      { id: 'f10', frameNumber: 10, code: '10A', sceneTitle: 'konser', dateStr: '25.07', isExposed: true, bgColors: ['#6B7052', '#2A1730'], iconName: 'star' },
